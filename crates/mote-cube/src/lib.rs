...
use mote_kernel::{DeviceInfo, KernelArgs, KernelError, KernelImpl, KernelKey};
...
impl KernelImpl for PortableKernel {
    ...
    fn supports(&self, _device: &DeviceInfo, _key: &KernelKey) -> bool {
        true
    }

    fn launch(&self, _device: &DeviceInfo, _args: &KernelArgs<'_>) -> Result<(), KernelError> {
